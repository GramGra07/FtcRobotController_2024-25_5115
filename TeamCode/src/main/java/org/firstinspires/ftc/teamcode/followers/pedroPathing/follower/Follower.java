...
import static org.firstinspires.ftc.teamcode.followers.pedroPathing.tuning.FollowerConstants.frontLeftVector;
...
public class Follower {
    ...
    public void initialize() {
        driveVectorScaler = new DriveVectorScaler(frontLeftVector);
