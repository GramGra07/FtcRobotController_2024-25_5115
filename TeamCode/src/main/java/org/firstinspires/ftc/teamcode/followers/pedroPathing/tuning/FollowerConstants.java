...
public class FollowerConstants {
    ...
    private static double xMovement = CurrentDrivetrain.Companion.getCurrentDrivetrain().getPedroPathingPARAMS().getXMovement();
    private static double yMovement = CurrentDrivetrain.Companion.getCurrentDrivetrain().getPedroPathingPARAMS().getYMovement();
