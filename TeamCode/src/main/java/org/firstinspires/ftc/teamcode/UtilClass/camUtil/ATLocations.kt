...
class ATLocations {
    companion object {
        private var allLocations: List<Pair<Int, AprilTagLocation>> =
            listOf(
                Pair(1, AprilTagLocation(Point(-36 - 4.8, 61.0))), //bb Left
                Pair(2, AprilTagLocation(Point(-36.0, 61.0))), //bb mid
                Pair(3, AprilTagLocation(Point(-36 + 4.8, 61.0))), //bb right
                Pair(4, AprilTagLocation(Point(36 - 4.8, 61.0))), //rb left
                Pair(5, AprilTagLocation(Point(36.0, 61.0))), //rb mid
                Pair(6, AprilTagLocation(Point(36 + 4.8, 61.0))), //rb right
