...
public class DAVars {
    ...
    public static double hSpecimenE = 1200 * 1.249;
    public static double hSpecimenP = 1400;
    public static double hBasketE = 2250 * 1.249;
    public static double hBasketP = 2000;
    public static double pickUpE = 1100 * 1.249;
    public static double pickUpP = 0;
    public static double humanE = 200 * 1.249;
